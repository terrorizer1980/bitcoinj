...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        ...
        PeerAddress pa = new PeerAddress(MainBtcNetParams.get(),
    ...
    public void testBitcoinSerialize() throws Exception {
        PeerAddress pa = new PeerAddress(MainBtcNetParams.get(), InetAddress.getByName(null), 8333, 0, BigInteger.ZERO);
