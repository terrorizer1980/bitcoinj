...
public class BitcoinURITest {
    ...
    private static final NetworkParameters MAINNET = MainBtcNetParams.get();
    ...
    public void testBad_IncorrectAddressType() {
        try {
            testObject = new BitcoinURI(TestBtcNet3Params.get(), BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS);
            fail("Expecting BitcoinURIParseException");
        } catch (BitcoinURIParseException e) {
    ...
    public void testPaymentProtocolReq() throws Exception {
        ...
        BitcoinURI uri = new BitcoinURI(TestBtcNet3Params.get(), "bitcoin:?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin%2Ff.php%3Fh%3Db0f02e7cea67f168e25ec9b9f9d584f9");
    ...
    public void testUnescapedPaymentProtocolReq() throws Exception {
        BitcoinURI uri = new BitcoinURI(TestBtcNet3Params.get(),
